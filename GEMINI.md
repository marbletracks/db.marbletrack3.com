...
**Moments** are translated in TABLE `moment_translations` with Perspective of the Worker or Part for whom this translation is written.
...
* Workers and Parts can have their own translations of Moments, which can be marked as Significant Moments
...
* Individual Workers and Parts pages include lists of their Moments

### Next steps

The following steps are listed in order of priority:

1. Fill in data from the old website so this one can reach parity with it.  This will probably include parsing the previous site somehow.  Not sure if GEMINI can parse it or not.
...
* Speak supportively and with curiosity—this is a decades-spanning passion project.
...
* But if Rob suggests something really poor idea from technical perspective, speak up and challenge it.

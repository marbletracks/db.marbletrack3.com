...
INSERT INTO worker_names (worker_id, language_code, worker_name, worker_description) VALUES
  ((SELECT worker_id FROM workers WHERE worker_alias = 'square'), 'en',
    'Squarehead', 'Squarehead often gets confused, often seen clumsily and not knowing what''s going on.'),
  ((SELECT worker_id FROM workers WHERE worker_alias = 'rab'), 'en',
  ...
  ((SELECT worker_id FROM workers WHERE worker_alias = 'lil'), 'en',
  ...
  ((SELECT worker_id FROM workers WHERE worker_alias = 'cm'), 'en',
  ...
  ((SELECT worker_id FROM workers WHERE worker_alias = 'rg'), 'en',
  ...
  ((SELECT worker_id FROM workers WHERE worker_alias = 'gar'), 'en',
    'Garinoppi', 'Garinoppi is a skeleton who had a cameo appearance flying the stage rotation bearing into place.'),
  ((SELECT worker_id FROM workers WHERE worker_alias = 'francois'), 'en',
  ...
  ((SELECT worker_id FROM workers WHERE worker_alias = 'auto'), 'en',

...
try {
    ...
    $expanded_with_workers = $worker_repo->expandShortcodesForFrontend($text, "worker", $langCode);
    $fully_expanded = $parts_repo->expandShortcodesForFrontend($expanded_with_workers, "part", $langCode);
